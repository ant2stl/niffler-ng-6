...
public class UsersQueueExtension implements
    ...
    static {
        EMPTY_USERS.add(new StaticUser(
                "duck", "qwer1234", null, null, null));
        WITH_FRIEND_USERS.add(new StaticUser(
                "duck_with_friend", "qwer1234", "duck_with_friend1", null, null));
        WITH_INCOME_REQUEST_USERS.add(new StaticUser(
                "duck_with_income_ request", "qwer1234", null, "duck_waiting_for_friend", null));
        WITH_OUTCOME_REQUEST_USERS.add(new StaticUser(
                "duck_waiting_for_friend", "qwer1234", null, null, "duck_with_income_ request"));
    }
